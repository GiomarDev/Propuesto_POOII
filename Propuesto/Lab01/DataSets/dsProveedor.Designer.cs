...
namespace Lab01.DataSets {
    ...
    public partial class dsProveedor : global::System.Data.DataSet {
        ...
        public partial class ProveedoresDataTable : global::System.Data.TypedTableBase<ProveedoresRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProveedoresRow AddProveedoresRow(string Nombre, string Direccion, string NombreContacto, string CargoContacto, int IdPais, string Telefono, string Fax) {
            ...
            private void InitClass() {
                ...
                this.columnCargoContacto.AllowDBNull = false;
                this.columnCargoContacto.MaxLength = 50;
...
namespace Lab01.DataSets.dsProveedorTableAdapters {
    ...
    public partial class ProveedoresTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Compras].[Proveedores] WHERE (([IdProveedor] = @Original_IdProveedor" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Compras].[Proveedores] ([Nombre], [Direccion], [NombreContacto], [Ca" +
                "rgoContacto], [IdPais], [Telefono], [Fax]) VALUES (@Nombre, @Direccion, @NombreC" +
                "ontacto, @CargoContacto, @IdPais, @Telefono, @Fax)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Compras].[Proveedores] SET [Nombre] = @Nombre, [Direccion] = @Direccion, " +
                "[NombreContacto] = @NombreContacto, [CargoContacto] = @CargoContacto, [IdPais] =" +
                " @IdPais, [Telefono] = @Telefono, [Fax] = @Fax WHERE (([IdProveedor] = @Original" +
                "_IdProveedor))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["POOIIConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdProveedor, Nombre, Direccion, NombreContacto, CargoContacto, IdPais, Tel" +
                "efono, Fax FROM Compras.Proveedores";
        ...
        public virtual int Insert(string Nombre, string Direccion, string NombreContacto, string CargoContacto, int IdPais, string Telefono, string Fax) {
            if ((Nombre == null)) {
            ...
            if ((CargoContacto == null)) {
                throw new global::System.ArgumentNullException("CargoContacto");
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(CargoContacto));
            }
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(IdPais));
            if ((Telefono == null)) {
        ...
        public virtual int Update(string Nombre, string Direccion, string NombreContacto, string CargoContacto, int IdPais, string Telefono, string Fax, int Original_IdProveedor) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
